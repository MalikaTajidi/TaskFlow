  ...
  const ganttTasks = useMemo(() => {
    return (
      projects?.map((project) => ({
        ...
        name: project.name || "Untitled project", // Set default if name is undefined
    ...
    <div className="max-w-full p-8">
      <header className="mb-4 flex items-center justify-between">
        ...
        <div className="relative inline-block w-64">
          <select
            id="view-mode-select" // Added id for accessibility
            name="viewMode" // Optional: added name attribute
